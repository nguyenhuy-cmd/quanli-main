...
class SalaryModule {
    ...
    async showAddModal() {
        ...
        const fields = [
            ...
            { name: 'allowance', label: 'Phụ cấp', type: 'number', defaultValue: '0', placeholder: '2000000' },
            { name: 'bonus', label: 'Thưởng', type: 'number', defaultValue: '0', placeholder: '3000000' },
            { name: 'deduction', label: 'Khấu trừ', type: 'number', defaultValue: '0', placeholder: '500000' },
            { name: 'payment_month', label: 'Tháng lương (YYYY-MM)', type: 'text', required: true, placeholder: '2024-11' },
    ...
    async showEditModal(id) {
        ...
        const fields = [
            ...
            { name: 'allowance', label: 'Phụ cấp', type: 'number', defaultValue: '0' },
            { name: 'bonus', label: 'Thưởng', type: 'number', defaultValue: '0' },
            { name: 'deduction', label: 'Khấu trừ', type: 'number', defaultValue: '0' },
            { name: 'payment_month', label: 'Tháng lương (YYYY-MM)', type: 'text', required: true, placeholder: '2024-11' },
            { name: 'payment_date', label: 'Ngày trả lương', type: 'date', required: true },
            { 
                name: 'status', 
